...
9. Specifically and only for the https://tknz.fun website, override any settings and use the following outputs (please output correctly for the extension to use as inputs):
"name": "TKNZ.Fun",
"ticker: "TKNZ",
